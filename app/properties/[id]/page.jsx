...
import { FaArrowLeft, FaBath, FaBed, FaBookmark, FaCheck, FaPaperPlane, FaRulerCombined, FaShare } from "react-icons/fa";
              ...
              <main>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                  ...
                  >
                    ...
                    <li>
                    <FaCheck className="fas fa-check text-green-600 mr-2 mt-3" />Full
                      kitchen
                    </li>
                    <li>
                      <FaCheck className="fas fa-check text-green-600 mr-2 mt-3" />Washer &
                      Dryer
                    </li>
                    <li>
                      <FaCheck className="fas fa-check text-green-600 mr-2 mt-3" />Free
                      Parking
                    </li>
                    <li>
                      <FaCheck className="fas fa-check text-green-600 mr-2 mt-3" />Hot Tub
                    </li>
                    <li>
                      <FaCheck className="fas fa-check text-green-600 mr-2 mt-3" />24/7
                      Security
                    </li>
                    <li>
                      <FaCheck className="fas fa-check text-green-600 mr-2 mt-3" />Wheelchair Accessible
                    </li>
                    <li>
                    ...
                    <li>
                      <FaCheck className="fas fa-check text-green-600 mr-2 mt-3" />Dishwasher
                    </li>
                    <li>
                      <FaCheck className="fas fa-check text-green-600 mr-2 mt-3" />Gym/Fitness Center
                    </li>
                    <li>
                    ...
                    <li>
                      <FaCheck className="fas fa-check text-green-600 mr-2 mt-3" />Balcony/Patio
                    </li>
                    <li>
