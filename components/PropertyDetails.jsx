  ...
  return (
    <main>
      ...
      >
        ...
        >
          <FaMapMarker
            className="fa-solid text-lg text-orange-700 mr-2"
          />
            ...
            <div className="text-gray-500 mr-2 font-bold">Nightly</div>
              <div className='text-2xl'>
                {property.rates.nightly ?
                  <div className="text-blue-500 font-bold">${property.rates.nightly.toLocaleString()}</div> :
            ...
            <div className="text-gray-500 mr-2 font-bold">Weekly</div>
              <div className='text-2xl'>
                {property.rates.weekly ?
                  <div className="text-blue-500 font-bold">${property.rates.weekly.toLocaleString()}</div> :
                  <FaTimes className="text-red-700" />
                }
              </div>
          </div>
            ...
            <div className="text-gray-500 mr-2 font-bold">Monthly</div>
              <div className='text-2xl'>
                {property.rates.monthly ?
                  <div className="text-blue-500 font-bold">${property.rates.monthly.toLocaleString()}</div> :
                  <FaTimes className="text-red-700" />
                }
              </div>
          </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md mt-6">
        ...
        >
          {property.amenities.map(amenity => (
            <li>
              <FaCheck className="fas fa-check text-green-600 mr-2 mt-3" key={amenity}/>{amenity}
            </li>
          ))}
        </ul>
      </div>
